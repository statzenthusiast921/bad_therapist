        ...
        dcc.Tab(
            ...
            children=[
                html.Div([
                    ...
                    html.P("[Dr. Vain uses a RAG system to answer your questions. When a question is asjed, he searches a", html.A(" Pinecone vector database ", href='https://www.pinecone.io/?utm_term=pinecone%20vector%20database&utm_campaign=brand-us-e&utm_source=adwords&utm_medium=ppc&hsa_acc=3111363649&hsa_cam=21023369441&hsa_grp=167470667468&hsa_ad=690982708943&hsa_src=g&hsa_tgt=kwd-1538083228315&hsa_kw=pinecone%20vector%20database&hsa_mt=e&hsa_net=adwords&hsa_ver=3&gad_source=1&gad_campaignid=21023369441&gbraid=0AAAAABrtGFCYqLoEGkHl6VCHsW4UEz6vQ&gclid=CjwKCAiAs4HMBhBJEiwACrfNZVRo8jO5bvRVGtxn8I3GRJtlU55bER_iJMaO6J_wLnUGHjeur90moxoCK6kQAvD_BwE'), "to retrieve relevant context. This information is combined with the question and sent to the", html.A(" Groq Llama 3.3-70B language model ", href = 'https://console.groq.com/docs/model/llama-3.3-70b-versatile'), "to generate a response. (Note: Groq is not the same as the 'Grok' AI model from X/Twitter). All processing has been shifted from local hosting", html.A(" (Ollama) ", href = 'https://ollama.com/), "to the cloud. This allows Dr. Vain to leverage powerful remote servers to handle complex computations instantly without slowing down the user experience."], style={'color':'white'}),                    
                    html.Br(),
                    
                    html.P(dcc.Markdown('**Does Dr. Vain have any limitations?**'), style={'text-decoration': 'underline','color':'white'}),
                    html.P("Dr. Vain has several limitations. The responses are generated by the Llama 3.3-70B model via Groq, which may occasionally produce inconsistent, repetitive, or contextually inappropriate answers. The model's knowledge is limited to its training data and the information in the Pinecone database. Additionally, it's important to note that Dr. Vain is intentionally designed to provide bad therapeutic advice as part of his narcissistic character - he is not a real therapist and should not be used for actual mental health guidance.", style={'color':'white'})
                ])
            ]
        ),
