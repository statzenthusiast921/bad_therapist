        ...
        dcc.Tab(
            ...
            children=[
                html.Div([
                    ...
                    html.P("Dr. Vain is a RAG (Retrieval-Augmented Generation) chatbot designed to simulate the world's most brilliant (and self-obsessed) therapist. He utilizes state-of-the-art cloud intelligence to ensure that no matter how complex your problems are, the conversation always leads back to his favorite subject: himself.", style={'color':'white'}),
                    html.Br(),
                    
                    html.P(dcc.Markdown('**How does Dr. Vain operate?**'), style={'text-decoration': 'underline','color':'white'}),
                    html.P("Dr. Vain operates on a high-performance RAG architecture. When you speak, he instantly queries a Pinecone Vector Database for relevant context. This context is then processed by the Groq Llama 3.3-70B model—one of the fastest large language models available—to generate his characteristically dismissive and egotistical responses in real-time.", style={'color':'white'}),
                    html.Br(),
                    
                    html.P(dcc.Markdown('**Does Dr. Vain have any limitations?**'), style={'text-decoration': 'underline','color':'white'}),
                    html.P("While Dr. Vain would claim to have no flaws, his intelligence is provided by the Groq Cloud API. Though incredibly fast, the model may occasionally offer repetitive anecdotes about its own success. Most importantly: Dr. Vain is a satirical character designed to provide intentionally poor advice. He is NOT a real therapist and should never be used for actual mental health guidance.", style={'color':'white'})
                ])
            ]
        ),
