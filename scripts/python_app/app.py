    ...
    dcc.Tabs(id='app-tabs', children=[ 
        ...
        dcc.Tab(
            ...
            children=[
                html.Div([
                    ...
                    html.P([
                        "When a user submits a query, the system pulls relevant data from a ", 
        ...
        dcc.Tab(
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                html.P([html.B("Email:"), " Thad.Vain.Superiority@gmail.com"], style={'margin': '0', 'color':'#FFFFFF'}),
                                html.P([html.B("Private Line:"), " (555) 555-THAD"], style={'margin': '5px 0', 'color':'#FFFFFF'}),
                                html.P([html.B("Location:"), " Vain Tower, Penthouse, Your Town, Planet Earth"], style={'margin': '5px 0', 'color':'#FFFFFF'}),
                ...
                html.Br(),
                html.P(html.B("The Patient-Zero Award"), style={'margin-bottom': '0px','color':'#FFFFFF'}),
                html.P("For single-handedly raising the bar of what a therapist should be. (2018)",style = {'color':'#FFFFFF'}),
                html.Br(),
                ...
                html.P("Staring at my reflection for prolonged self-affirmation.",style = {'color':'#FFFFFF'}),
                html.Hr()
            ]
        ),
