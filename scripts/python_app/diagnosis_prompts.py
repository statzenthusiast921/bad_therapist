...
Provide a brief assessment of the patient's psychological state based on the session history. Write in clinical but condescending language that subtly suggests the patient's issues are relatively minor or common, while implying that only a therapist of exceptional caliber (like yourself) could properly address them. This paragraph should be 3-5 sentences (maximum 5 sentences).
